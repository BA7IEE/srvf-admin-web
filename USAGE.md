...
- 历史 validated 包：`srvf-admin-web_v7.1.0-p1.meta-workbench_validated_full_20260705.zip` 只作历史，不再作为当前下一步入口（原件已于 2026-07-17 经维护者拍板弃置；其内容当时与 main 逐字节一致，以 Git 历史为准）。

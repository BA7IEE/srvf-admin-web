...
> **📌 2026-07-06**：与 v0.37.0 的逐条结构对账（前端 SRVF 调用 105/105 命中现行契约）、67 条未消费路径清单与 vNext 路线图见 **`docs/srvf-admin-vnext-blueprint.md`**。下文「仅通知中心待建」等为 2026-06-28 时点表述——通知中心已于 PR #26 上线。本文的 auth/RBAC 接线流程仍现行有效。

...
interface Props {
  treeLoading: boolean;
  treeData: any[];
  openDictDialog: (title?: string, row?: any) => void;
  getDictTreeData: () => void;
}
...
<template>
  ...
  >
    ...
    <el-button
      class="w-[90%] absolute bottom-5.5 left-[50%] -translate-x-[50%]"
      type="primary"
      :icon="useRenderIcon(AddFill)"
      @click="props.openDictDialog()"
    >
      新增字典
    </el-button>
  </div>
